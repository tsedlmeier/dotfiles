...
function theme.at_screen_connect(s)
    ...
    s.mywibox:setup {
        ...
        { -- Right widgets
            ...
            -- arrow("#4B3B51", "#CB755B"),
            -- wibox.container.background(wibox.container.margin(weather , dpi(3), dpi(3)), "#CB755B"),
            arrow("#4B696D","#8DAA9A"),
            ...
            arrow("#8DAA9A", "#3F3F3F"),
            wibox.container.background(wibox.container.margin(wibox.widget { nil, neticon, net.widget, layout = wibox.layout.align.horizontal }, dpi(3), dpi(3)), "#3F3F3F"),
            --arrow("#C0C0A2", "#777E76"),
            ...
            ----------------------------------  Weather   -----------------------------
            weather_widget({
            api_key='891af36031bbce896eaeb204d9e861ee',
            coordinates = {49.460983, 11.061859},
